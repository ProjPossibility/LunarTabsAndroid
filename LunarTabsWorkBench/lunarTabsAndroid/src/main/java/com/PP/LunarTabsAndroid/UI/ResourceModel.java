...
public class ResourceModel {
	...
	public String CALIB_GRAPH_TITLE;
	public String CALIB_GRAPH_X;
	public String CALIB_GRAPH_Y;
	public String[] CALIB_GRAPH_LEGEND;
	public String THRESH_LABEL;
	...
	public void loadResources(Context context) {
		...
		CALIB_GRAPH_TITLE = context.getResources().getString(R.string.calib_graph_title);
		CALIB_GRAPH_X = context.getResources().getString(R.string.calib_graph_x);
		CALIB_GRAPH_Y = context.getResources().getString(R.string.calib_graph_y);
		CALIB_GRAPH_LEGEND = context.getResources().getStringArray(R.array.calib_graph_legend);
		THRESH_LABEL = context.getResources().getString(R.string.thresh_label);
		DELAY_LABEL = context.getResources().getString(R.string.delay_label);
	}
}
