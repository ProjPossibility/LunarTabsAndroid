...
public class StomperCalibActivity extends Activity implements SensorEventListener, StompListener, OnClickListener  {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bean = new TimeSeriesChartBean(this,ResourceModel.getInstance().CALIB_GRAPH_TITLE,
				ResourceModel.getInstance().CALIB_GRAPH_X, ResourceModel.getInstance().CALIB_GRAPH_Y,
				ResourceModel.getInstance().CALIB_GRAPH_LEGEND,new int[] {Color.BLUE,Color.RED, Color.RED});
		/*
		bean = new TimeSeriesChartBean(this,"Accelerometer Monitor",
				"Time","Accel Reading",
				new String[] {"Accelerometer","Upper Sensitivity Threshold","Lower Sensitivity Threshold"},
				new int[] {Color.BLUE,Color.RED, Color.RED});
		*/
...
//		delayTV.setText("Delay: " + untriggerDelayParam + "ms");
		thresholdTV.setText(ResourceModel.getInstance().THRESH_LABEL+ decFormat.format(sensitivityParam));
		delayTV.setText(ResourceModel.getInstance().DELAY_LABEL+ untriggerDelayParam + "ms");
